    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 pb-20">
            ...
            <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 transition-all duration-500 ${isRestricted ? 'opacity-60 grayscale' : ''}`}>
                ...
                <button onClick={() => { if (!isRestricted) navigate('/dashboard/history') }} className="bg-white border border-neutral-100 p-6 rounded-[2.5rem] shadow-sm flex items-center gap-5 hover:border-primary/30 transition-all text-left group">
                    ...
                    {user?.role === 'vendor' && (
                        <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8">
                            ...
                            <div className="flex gap-4">
                                <button onClick={() => navigate('/dashboard/substores')} className="bg-primary text-white font-bold px-6 py-3 rounded-xl hover:bg-primary-dark transition-colors">
                                    Create Sub-Store
                                </button>
                                <button onClick={() => navigate('/dashboard/reports')} className="bg-white border border-neutral-200 text-foreground font-bold px-6 py-3 rounded-xl hover:bg-neutral-50 transition-colors">
                                    View Reports
                                </button>
                            </div>
                        </div>
